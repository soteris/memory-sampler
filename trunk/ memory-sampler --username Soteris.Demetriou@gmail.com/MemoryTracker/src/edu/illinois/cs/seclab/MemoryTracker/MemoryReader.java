...
//	}
	 ...
	 * getTotalPss()
	 * 
	 * @return total PSS memory metric of all running processes or null if not available. It returns a linked list with Memory Info 
	 * Arrays for each process or null if the list is empty.
	 * Pss number is a metric the kernel computes that
	 ...
	 * 
	 * @param a android.os.Debug.MemoryInfo[]
	 * @param b	Map<Integer, String> - a map of the pids(number, description) in the memoryInfo array
	 * @param c int pids[] : an array with the number of pids in the map
	 * @param d String pids[] : an array with the number of pids in the map
	 */
